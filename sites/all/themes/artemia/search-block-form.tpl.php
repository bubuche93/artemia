...
$search["search_block_form"]= str_replace('id="edit-search-block-form-1"', 'id="edit-search-block-form-1" class="inputtextsearch" onblur="if (this.value == \'\') {this.value = \'Entrez votre recherche\';}" onfocus="if (this.value == \'Entrez votre recherche\') {this.value = \'\';}" ', $search["search_block_form"]);
